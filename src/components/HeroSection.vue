  ...
  >
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-16 items-center">
      ...
      >
        ...
        <h1 class="font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-normal mb-2">
        ...
        <p class="font-body text-text-secondary text-lg leading-relaxed mb-10 max-w-lg">
          Build a full stack system that is <span class="text-accent-primary">scalable</span>,
          <span class="text-accent-light">reliable</span>, and
          <span class="text-accent-primary">performant</span>.
          Full stack developer specializing in API design, and database optimization.
        </p>
        ...
        <div class="flex items-center gap-6 mt-10">
          <a href="https://github.com/imamsudarajat04" target="_blank" rel="noopener" aria-label="GitHub" class="text-text-muted hover:text-accent-primary transition-colors duration-200">
          ...
          <a href="mailto:imamsudarajat708@gmail.com" aria-label="Email" class="text-text-muted hover:text-accent-primary transition-colors duration-200">
        ...
        <div class="card-glass rounded-xl overflow-hidden glow-border animate-float">
          ...
          <div class="p-6 font-mono text-sm space-y-2">
            ...
            <div class="pl-2 text-xs leading-relaxed">
              ...
              <p class="pl-4"><span class="text-text-muted">"languages"</span>: <span class="text-text-secondary">["Laravel", "Go", "Typescript", "VueJS"],</span></p>
              <p class="pl-4"><span class="text-text-muted">"databases"</span>: <span class="text-text-secondary">["PostgreSQL", "MySQL", "Redis"],</span></p>
              <p class="pl-4"><span class="text-text-muted">"devops"</span>: <span class="text-text-secondary">["Docker", "CI/CD"],</span></p>
              <p class="pl-4"><span class="text-text-muted">"exp"</span>: <span class="text-accent-primary">"3+ years"</span></p>
              <p><span class="text-accent-light">}</span></p>
            </div>
